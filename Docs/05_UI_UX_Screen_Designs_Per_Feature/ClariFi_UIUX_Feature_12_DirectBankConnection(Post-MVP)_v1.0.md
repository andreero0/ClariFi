...
* Bank logos grid below

##### Plaid Link Flow State
* Native Plaid interface embedded
* ClariFi branding in header
* Bank selection screen
* Credentials input (bank's UI)
* Account selection checkboxes
* Success checkmark animation
* Return to app seamlessly

##### Sync Status Screen State
* Connected accounts list:
  * Bank logo and name
  * Account type and last 4
  * Last sync timestamp
...
* Status cards for each connection:
