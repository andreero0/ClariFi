...
Here’s the 7th feature.
## Feature 7: Basic Newcomer Financial Education (MVP)

### Education Hub Screen
##### Module Grid State
* "Financial Education" H2 header
* Welcome message for newcomers
* Module cards in vertical list:
  * Large icon (48dp) with gradient background
  * Module title and description
  * Progress ring showing completion
  * Estimated time badge
  * "Start" or "Continue" button
* Locked modules show with 50% opacity
* Completed modules show checkmark badge

##### Module Progress State
* Progress bar at top of screen (sticky)
* Current chapter indicator
* "3 of 8 chapters complete"
* Bookmark icon to save position
* Achievement progress hint at bottom

### Module Viewer Screen
##### Content Reading State
* Clean reader interface with optimal line length
* Chapter navigation dots at top
* Content with rich formatting:
  * Headers in H3 style
  * Body text with 1.5x line height
  * Highlighted key terms (tap for glossary)
  * Embedded illustrations
* Interactive elements inline:
  * Calculators with real-time results
...
* Multiple choice options as tappable cards
* Selected option highlights in Clarity Blue
* "Check Answer" button activates
* Correct: Green checkmark with explanation
* Incorrect: Red X with helpful hint
* Progress dots showing question X of Y
* Score summary at end with badge earned

### Language Selector
##### Language Switch State
* Language button in top-right (globe icon)
* Dropdown with available languages
* Current language checkmarked
* Smooth content transition on switch
* RTL support for applicable languages

### Achievement Screen
##### Achievement Unlocked State
* Full-screen celebration overlay
* Badge animates in with bounce effect
* "Achievement Unlocked!" header
* Badge name and description
* Points earned counter animating up
* Confetti or particle effects (subtle)
