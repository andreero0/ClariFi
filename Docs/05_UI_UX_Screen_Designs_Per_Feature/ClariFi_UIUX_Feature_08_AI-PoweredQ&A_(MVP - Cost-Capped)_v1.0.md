...
Here’s the 8th feature.
## Feature 8: AI-Powered Q&A (MVP - Cost-Capped)

### Chat Interface Screen
##### Chat Default State
* "Ask ClariFi" header with beta badge
* Usage indicator: "3 of 5 AI questions remaining"
* Suggested questions chips:
  * "How can I improve my credit?"
  * "What's my biggest expense?"
  * "Should I pay off Card A or B?"
* Message history with alternating alignment
* User messages: Right-aligned, Clarity Blue background
* AI messages: Left-aligned, Cloud Gray background
* Typing indicator with three animated dots

##### Query Input State
* Bottom input bar with rounded corners
* Text input with "Ask a question..." placeholder
* Send button activates when text entered
* Character count if approaching limit
* Mic icon for future voice input (disabled)

##### AI Response Loading State
* Typing indicator animates (dots scaling)
* "ClariFi is thinking..." status text
* Subtle pulse on chat bubble being created
* Response streams in word by word

##### Usage Limit Reached State
* Soft warning at 4/5 questions used
* Hard stop at 5/5 with explanation
* "Resets on [date]" message
* Suggestion to check FAQ
* "Upgrade to Premium" CTA for unlimited

### FAQ Browser Screen
##### FAQ Category View State
...
* "Ask AI" button if have questions remaining
