...
Here’s the 10th feature.
## Feature 10: Lean Support System (MVP)

### Help Center Screen
##### Help Home State
* "How can we help?" H2 header
* Search bar with icon and recent searches
* Quick links grid:
  * Getting Started
  * Troubleshooting  
  * Feature Guides
  * Contact Us
* "Popular Articles" section below
* Each article shows view count
* "Join Community" banner at bottom

##### Search Results State
* Search query shown with clear button
* Results grouped by type:
  * Articles (with preview text)
  * FAQs (with direct answers)
  * Video guides (with thumbnails)
* No results: Helpful suggestions
* "Contact Support" if can't find answer
...
* "Contact Support" H2 header
* Category dropdown (mandatory)
* Subject line input
* Message textarea with 500 char limit
* File attachment option (screenshots)
* "Send" button (disabled until filled)
* "Expected response: 24-48 hours" note

##### Ticket Submitted State
* Checkmark animation
* "Ticket #12345 submitted" confirmation
* "We'll email you at [email]" message
* "View FAQ" secondary button
* Auto-return to help center after 3s
