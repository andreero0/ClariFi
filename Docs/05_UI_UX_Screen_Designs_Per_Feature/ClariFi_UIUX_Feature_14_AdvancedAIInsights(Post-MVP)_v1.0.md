...
* Parameter sliders:
  ...
  * Expense categories adjustable
  * Major purchases toggle
...
* "Most Likely" badge on realistic
* Export scenarios option

### Peer Comparison Screen
##### Comparison View State
* "How You Compare" header
* Your demographic group shown
* Metric cards with percentiles:
  * Savings rate: "You: 15% | Peers: 12%"
  * Credit utilization: Better than 73%
  * Monthly expenses: Lower than 67%
* Visual percentile bars
* "Areas to Improve" section
* Privacy note about anonymous data
