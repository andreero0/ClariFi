...
Here’s the 13th feature.
## Feature 13: Business Features (Post-MVP)

### Business Dashboard Screen
##### Business Overview State
* Business/Personal toggle in header
* Business name and tax year displayed
* Four metric cards:
  * Revenue (Growth Green)
  * Expenses (Clarity Blue)
  * Tax Owed (Warning Orange)
  * Profit (Wisdom Purple)
...
* Camera view with receipt overlay guide
* "Align receipt in frame" instruction
* Auto-capture on detection
* Flash and gallery options
* After capture:
...
##### Business Expense List State
* Month selector with tax year context
* Expense list with rich information:
  * Receipt thumbnail (if available)
  * Merchant and amount
  * Tax badge (GST/HST amount)
